...
class Lexer:
    ...
    def scan_token(self) -> None:
        ...
        match c:
            ...
            case "/":
                if self.match("*"):
                    while not self.match('*') and self.peek_next() != '/' and not self.is_at_eof():
                        if self.peek() == "\n":
                            self.line += 1
                    ...
                    if self.is_at_eof():
                        from Pox import Pox
                        Pox.error(self.line, f'Unterminated block comment found.')
            ...
            case _:
                if self.is_digit(c):
                    ...
                    Pox.error(self.line, f'Unexpected character found: "{c}"')
    ...
    def string(self) -> None:
        ...
        if self.is_at_eof():
            Pox.error(self.line, f"Unterminated string.")
